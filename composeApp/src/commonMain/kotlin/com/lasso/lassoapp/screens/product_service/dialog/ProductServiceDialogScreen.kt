...
fun ProductDialogScreen(
    lassoItem: LassoItem?,
    onDismiss: () -> Unit,
    onProductServiceRegistered: (lassoItem: LassoItem) -> Unit,
) {
    val viewModel = koinViewModel<ProductServiceDialogViewModel>()

    ProductDialogContent(viewModel, lassoItem, onDismiss, onProductServiceRegistered)
}
