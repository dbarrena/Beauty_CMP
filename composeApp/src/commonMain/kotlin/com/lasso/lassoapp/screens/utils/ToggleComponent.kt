...
fun SelectionPill(
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            containerColor = if (selected) highlighted() else nonHighlighted(),
            contentColor = if (selected) onHighlighted() else onNonHighlighted(),
        ),
...
@Composable
fun highlighted() = MaterialTheme.colorScheme.primary

@Composable
fun nonHighlighted() = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.38f)

@Composable
fun onHighlighted() = MaterialTheme.colorScheme.onPrimary

@Composable
fun onNonHighlighted() = MaterialTheme.colorScheme.onSurface